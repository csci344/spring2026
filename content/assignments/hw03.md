...
{% collapsible %}
### 1. Page Initialization Tasks (20 Points)<span id="init"></span>
...
<figure>
    <figcaption id="ec1"><h3>Extra Credit #1: Following and Unfollowing</h3></figcaption>
...
<figure>
    <figcaption id="ec2"><h3>Extra Credit #2: Add Comment</h3></figcaption>
    <p>Note that each button click is issuing a request to your API and redrawing the screen (console messages just used for demonstration purposes).</p>
