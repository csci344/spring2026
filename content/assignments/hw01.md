...
## 3. Written Analysis (1-2 Pages single spaced)
You will create a 1-2 page document with the following components:
...
In your report, explain the controversy clearly enough that someone unfamiliar with the issue could understand what is happening and why it matters.
...
### Description of the Controversy (Paper)  --  4 points
...
### Analysis of the Controversy (Paper)   --  6 points
...
### Writing & Citation  --  2 points (Paper) 
...
### Presentation  --  4 points (Slides, In-Class Presentation) 
