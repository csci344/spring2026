...
**Desktop Version**
<table class="interface-table" style="background: white;">
    <tr>
        <td colspan="2" style="border-color: white !important;">
    ...
    <tr class="body">
        ...
        <td class="left" style="background-color: #f4F4F4;padding:20px;">
...
<table class="interface-table" style="width:50%;background: white;">
    <tr>
...
### 1. Navigation Bar (2 points)<span id="nav"></span>
...
<img style="border: solid 1px #CCC;margin-bottom:20px;" class="large" src="/spring2026/images/homework/hw02/navbar.png"/>

<img style="border: solid 1px #CCC;" class="large" src="/spring2026/images/homework/hw02/navbar-debug.png"/>

### 2. Recommendations Panel (4 points)<span id="recs"></span>
...
<div style="display: flex !important; gap: 40px;align-items: flex-start;">
...
### 3. Stories Panel (3 points)<span id="stories"></span>
...
<img style="width:80%;border: solid 1px #CCC;margin-bottom:20px;" src="/spring2026/images/homework/hw02/stories.png"/>
<img style="width:80%;border: solid 1px #CCC;" src="/spring2026/images/homework/hw02/stories-debug.png"/>

### 4. Card (7 points)<span id="card"></span>
...
<img align="top" style="width:60%;margin-bottom:20px;" src="/spring2026/images/homework/hw02/card.png"/>

<img style="width:60%;" src="/spring2026/images/homework/hw02/card-debug.png"/>

### 5. Composition (5 points)<span id="composition"></span>
...
### 6. Accessibility (4 points)<span id="accessibility"></span>
...
|------------------|----------|--------|
| [ ] Nav Bar | [4 requirements](#nav) | 2 |
| [ ] Recommendations Panel | [4 requirements](#recs) | 4 |
| [ ] Stories Panel | [3 requirements](#stories) | 3 |
| [ ] Card | [7 requirements](#card) | 7 |
| [ ] Composition | [5 requirements](#composition) | 5 |
| [ ] Accessibility | [2 requirements](#accessibility) | 4 |
| | **Total** | **25** |
