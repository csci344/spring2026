...
### Course Website
1. [CSS Rules of Thumb](css-01-rules-of-thumb)
1. [CSS Selectors](css-02-selectors)
1. [Color](css-03-color)
1. [Text & Fonts](css-04-fonts)
1. [Box Model](css-05-box-model)
1. [CSS Units](css-06-units)
1. [Flexbox](css-07-flexbox)
1. [CSS Grid](css-08-grid)
1. [Media Queries](css-09-media-queries)
1. [Style Guides](css-10-style-guides)
